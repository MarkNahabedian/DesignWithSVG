...
The sides are cut to $(box_length(boxGeo)) long by $(box_height(boxGeo) - boxGeo.stock_thickness + rabbet_depth(boxGeo)) high.
"""
...
# ╔═╡ 23ca86ee-3107-45ea-9093-7c19c203ff35
compartment_count(boxGeo)

# ╔═╡ 00000000-0000-0000-0000-000000000001
PLUTO_PROJECT_TOML_CONTENTS = """
[deps]
DarkMode = "933edf66-562e-4494-9e5f-31d7e8b9849e"
...
[[DarkMode]]
deps = ["InteractiveUtils", "JSON", "Markdown"]
git-tree-sha1 = "8057875723cde11a6f786eba502cf322c2027844"
repo-rev = "master"
repo-url = "https://github.com/Pocket-titan/DarkMode"
uuid = "933edf66-562e-4494-9e5f-31d7e8b9849e"
version = "0.1.0"
...
git-tree-sha1 = "4e5a4e4373ae09bce19f75a098af977d144b196c"
repo-rev = "master"
...
repo-rev = "master"
repo-url = "https://github.com/MarkNahabedian/ShaperOriginDesignLib"
